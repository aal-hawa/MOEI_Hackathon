...
import { MOCK_USERS, generateRandomMockUser } from '@/lib/uaepass-mock'
...
export function LoginPage() {
  ...
  const getRoleIcon = (role: string) => {
    switch (role) {
      ...
      case 'employee': return <Building2 className="w-4 h-4" />
  ...
  const getRoleColor = (role: string) => {
    switch (role) {
      case 'citizen': return 'bg-ae-green-500/10 text-ae-green-600 border-ae-green-500/20'
      case 'employee': return 'bg-blue-500/10 text-blue-600 border-blue-500/20'
      case 'admin': return 'bg-ae-gold-500/10 text-ae-gold-600 border-ae-gold-500/20'
  ...
  const getRoleLabel = (role: string) => {
    switch (role) {
      case 'citizen': return isAr ? 'مواطن' : 'Citizen'
      case 'employee': return isAr ? 'موظف' : 'Employee'
      case 'admin': return isAr ? 'مسؤول' : 'Admin'
      default: return role
    }
  }
  ...
  return (
    <div className="min-h-screen flex" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-ae-black-700 via-ae-black-700 to-ae-black-800">
        {/* Decorative elements */}
        <div className="absolute inset-0">
          <div className="absolute top-0 right-0 w-96 h-96 bg-ae-gold-500/5 rounded-full -translate-y-1/2 translate-x-1/2" />
          <div className="absolute bottom-0 left-0 w-72 h-72 bg-ae-gold-500/5 rounded-full translate-y-1/2 -translate-x-1/2" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] border border-ae-gold-500/10 rounded-full" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] border border-ae-gold-500/5 rounded-full" />
        </div>
            ...
            {authMode === 'mock' && (
              ...
              >
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3 min-w-0">
                              <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${
                                profile.role === 'admin' ? 'bg-ae-gold-500/10' :
                                profile.role === 'employee' ? 'bg-blue-500/10' :
                                'bg-ae-green-500/10'
                              }`}>
                              ...
                              <div className="min-w-0">
                                ...
                                <div className="flex items-center gap-2 mt-0.5">
                                  <Badge variant="outline" className={`text-[10px] h-5 px-1.5 ${getRoleColor(profile.role)}`}>
                ...
                <div className="mt-6">
                  ...
                  <div className="mb-4">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="w-7 h-7 rounded-lg bg-ae-black-700 flex items-center justify-center">
                        <Lock className="w-3.5 h-3.5 text-ae-gold-400" />
                      </div>
                      <h3 className="text-sm font-semibold text-ae-black-700">
                  ...
                  <div className="space-y-3">
                    ...
                    <Button
                      ...
                      className="w-full h-11 bg-ae-black-700 hover:bg-ae-black-800 text-white rounded-xl font-semibold"
                    >
                      {isAdminLoggingIn ? (
                        <motion.div
                          animate={{ rotate: 360 }}
