...
export function UAEPassLoginDialog({
  ...
  // Derive language from the HTML dir attribute / document —
  // consumers typically pass language via their own store; we
  // read it from the global app store to stay consistent.
  // Fallback: detect from <html dir>.
  const isAr = typeof document !== 'undefined' && document.documentElement?.dir === 'rtl'
  const language = isAr ? 'ar' as const : 'en' as const
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-2 mt-0.5">
                                <Badge
                                  variant="outline"
                                  className={cn('text-[10px] h-4 px-1.5', getProfileBadge(profile).className)}
                                >
