...
export function Header() {
  ...
  const displayName = userProfile?.fullnameEN || 'Finance Officer'
  const displayRole = userRole === 'superadmin' ? 'Super Admin' : userRole === 'admin' ? 'Administrator' : userRole === 'manager' ? 'Manager' : userRole === 'reviewer' ? 'Reviewer' : userRole === 'employee' ? 'Employee' : 'Finance Officer'
      ...
      <div className="flex items-center gap-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem className="text-[#E04E48] cursor-pointer font-medium" onClick={handleLogout}>
