  ...
  return (
    <div className="fixed inset-0 bg-black flex flex-col select-none overflow-hidden" style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", Roboto, sans-serif' }}>
      ...
      <div className="px-6 py-2 shrink-0 flex items-center absolute top-12 left-0 z-50">
        <a href="/customer" className="flex items-center gap-2 text-white/60 hover:text-white transition-colors text-sm font-medium bg-white/[0.06] hover:bg-white/[0.12] px-3 py-1.5 rounded-full backdrop-blur-sm">
      ...
      {screen === 'active' && (
        <div className="flex-1 flex flex-col min-h-0">
          ...
          {/* Error toast */}
          {errorMsg && (
            <div className="mx-4 mb-1 px-3 py-2 bg-red-500/20 rounded-xl text-red-300 text-xs text-center shrink-0 select-text">
              {errorMsg}
            </div>
          )}
